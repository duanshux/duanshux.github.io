import{_ as a,c as n,o as p,ai as i}from"./chunks/framework.x8cKHNbC.js";const k=JSON.parse('{"title":"部署vitepress","description":"","frontmatter":{"title":"部署vitepress","prev":false,"next":false},"headers":[],"relativePath":"software/vitepress/index.md","filePath":"software/vitepress/index.md","lastUpdated":1737625331000}'),e={name:"software/vitepress/index.md"};function l(t,s,c,h,o,d){return p(),n("div",null,s[0]||(s[0]=[i(`<h1 id="部署vitepress" tabindex="-1">部署vitepress <a class="header-anchor" href="#部署vitepress" aria-label="Permalink to &quot;部署vitepress&quot;">​</a></h1><h2 id="将vitepress部署在gitlab-pages" tabindex="-1">将vitepress部署在gitlab pages <a class="header-anchor" href="#将vitepress部署在gitlab-pages" aria-label="Permalink to &quot;将vitepress部署在gitlab pages&quot;">​</a></h2><p>在vitpress中创建三个文件，然后将viepress整体提交到gitlab，启用gitlab pages和gitlab ci自动构建，每次提交就会自动构建部署。</p><p>要添加的文件如下：</p><p>创建<code>.gitlab-ci.yml</code>，写入。</p><div class="language-yml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># The Docker image that will be used to build your app</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h2 id="将vitepress部署在github-pages" tabindex="-1">将vitepress部署在gitHub pages <a class="header-anchor" href="#将vitepress部署在github-pages" aria-label="Permalink to &quot;将vitepress部署在gitHub pages&quot;">​</a></h2><p>新建<code>.github\\workflows</code>两层文件夹，在workflows下新建<code>action.yml</code>文件，写入：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 构建 VitePress 站点并将其部署到 GitHub Pages 的示例工作流程</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span>          folder: public</span></span></code></pre></div><p>在workflow下新建<code>add.txt</code>文件，写入：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  &quot;scripts&quot;: {</span></span>
<span class="line"><span>    &quot;docs:dev&quot;: &quot;vitepress dev docs&quot;,</span></span>
<span class="line"><span>    &quot;docs:build&quot;: &quot;vitepress build docs&quot;,</span></span>
<span class="line"><span>    &quot;docs:preview&quot;: &quot;vitepress preview docs&quot;</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>在<code>https://github.com/settings/personal-access-tokens</code>中为要托管到的静态仓库新建密钥，注意要给密钥相应的权限。</p><p>在<code>https://github.com/上传的项目地址/settings/secrets/actions</code>中创建名为<code>ACCESS_TOKEN</code>的secret，值为前面生成的密钥。</p>`,17)]))}const g=a(e,[["render",l]]);export{k as __pageData,g as default};
